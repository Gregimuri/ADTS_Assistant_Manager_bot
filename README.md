...
Telegram-бот для менеджеров. Собирает счета по тегам `#СчетЕММ` и `#СчетТО` из Google-таблицы [База для бота](https://docs.google.com/spreadsheets/d/1sRy5VuFGEWsh_RZCGUkWKyKcLP8i6dO-F1smi4ok4Mk/edit).
